            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-20">
                    {services.map((service, index) => (
                        <div
                            key={index}
                            className="group p-8 bg-white border border-[#e8e4df] hover:shadow-[0_10px_30px_rgba(201,168,124,0.1)] transition-all duration-300 hover:-translate-y-1"
                        >
                            <div className="flex justify-between items-baseline mb-4">
                                <h3 className="text-2xl text-[#2d2d2d] font-light">{service.title}</h3>
                ...
                <div className="relative">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center p-8 md:p-12">
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl text-[#2d2d2d] font-light mb-2">Pack Novia Completo</h2>
                            <p className="text-3xl text-[#c9a87c] font-light mb-8">590€</p>
                            ...
                            <div className="space-y-6 text-[#6b6b6b] mb-10">
                                ...
                                <ul className="space-y-4 border-l-2 border-[#c9a87c]/30 pl-6">
                                    <li className="flex justify-between items-center">
                                        <span><strong>Prueba y Reserva</strong> <span className="text-sm text-[#999]">(Bloqueo de fecha)</span></span>
                                    ...
                                    <li className="flex justify-between items-center pt-2 border-t border-dashed border-[#e8e4df]">
                                        <span><strong>Invitada adicional</strong> <span className="text-xs text-[#999]">(Mínimo 1 persona)</span></span>
